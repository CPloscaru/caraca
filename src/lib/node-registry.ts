...
const NODE_REGISTRY_ARRAY = [
  ...
  // -- Future nodes (Phase 12-14 placeholders) --
  {
    ...
    outputs: [{ id: 'image-source-0', type: 'image' as const, label: 'Output' }],
    resultFields: { __outputImage: 'outputImage', __inputImageUrl: 'inputImageUrl', __inputDimensions: 'inputDimensions' },
    stripOnExport: ['outputImage', 'inputImageUrl', 'inputDimensions'],
    order: 50,
    available: true,
  },
  {
    ...
    resultFields: { __videoUrl: 'videoUrl', __cdnUrl: 'cdnUrl', __videoResults: 'videoResults' },
    stripOnExport: ['videoUrl', 'cdnUrl', 'videoResults'],
    order: 60,
    available: true,
  },
  {
