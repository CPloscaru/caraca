...
const NODE_REGISTRY_ARRAY = [
  ...
  },
  {
    ...
    stripOnExport: ['images', 'debugRequest', 'debugResponse', 'debugError'],
    order: 30,
    available: true,
  },
  {
  ...
  // -- Future nodes (Phase 12-14 placeholders) --
  {
    ...
    stripOnExport: ['outputImage', 'inputImageUrl', 'inputDimensions', 'debugRequest', 'debugResponse', 'debugError'],
    order: 50,
    available: true,
  },
  {
    ...
    stripOnExport: ['videoUrl', 'cdnUrl', 'videoResults', 'debugRequest', 'debugResponse', 'debugError'],
    order: 60,
    available: true,
  },
  {
